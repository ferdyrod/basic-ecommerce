...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cart_cartitem', 'total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=200, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'cart.cartitem': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '200', 'decimal_places': '2'})
        },
