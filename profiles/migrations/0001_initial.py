...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_address', (
            ...
            ('address1', self.gf('django.db.models.fields.CharField')(default='none', max_length=300)),
            ('address2', self.gf('django.db.models.fields.CharField')(default='none', max_length=300, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ...
            ('billing_address', self.gf('django.db.models.fields.BooleanField')(default=True)),
    ...
    models = {
        ...
        u'profiles.address': {
            ...
            'address1': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '300'}),
            'address2': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '300', 'null': 'True', 'blank': 'True'}),
